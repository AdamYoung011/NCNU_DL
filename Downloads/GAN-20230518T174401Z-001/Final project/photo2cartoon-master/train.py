...
def draw_curve(current_epoch):
  ...
  ax0.plot(x_epoch, d_loss['train'], 'c-', label='train')
  #ax0.plot(x_epoch, y_loss['val'], 'ro-', label='val')
  ax1.plot(x_epoch, g_loss['train'], 'y-', label='train')
  #ax1.plot(x_epoch, y_err['val'], 'ro-', label='val')
  if current_epoch == 0:
      ax0.legend()
      ax1.legend()
  fig1.savefig('/content/drive/MyDrive/photo2cartoon/dataset/train_d.jpg')
  fig2.savefig('/content/drive/MyDrive/photo2cartoon/dataset/train_g.jpg')

fig1 = plt.figure()
ax0 = fig1.add_subplot(111, title="d_loss")
fig2 = plt.figure()
ax1 = fig2.add_subplot(111, title="g_loss")
...
class UgatitSadalinHourglass(object):
    ...
    def train(self):
        ...
        for step in range(start_iter, self.iteration + 1):
            ...
            if step % 10 == 0:
            	d_loss['train'].append(Discriminator_loss.item())
            	g_loss['train'].append(Generator_loss.item())
            	draw_curve(step)
