...
def parse_args():
    ...
    parser.add_argument('--iteration', type=int, default=25000, help='The number of training iterations')
    ...
    parser.add_argument('--cam_weight', type=int, default=0, help='Weight for CAM')
